...
public class ApiDataFunction extends AbstractJiraFunctionProvider {
    ...
    public void execute(Map transientVars, Map args, PropertySet ps) throws WorkflowException {
        ...
        try {
            ...
            AbstractFunctionFactory.sendErrorEmail("ru.mail.jira.plugins.contentprojects.issue.functions.apiError", null, issue, new ArrayList<CustomField>(Arrays.asList(urlCf, publishingDateCf)));
